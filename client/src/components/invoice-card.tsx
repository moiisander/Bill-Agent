...
type ProcessedInvoice = ProcessedInvoiceData["invoice"];
type ProcessedFile = ProcessedInvoiceData["file"];
...
export function InvoiceCard({ invoiceData, fileData }: InvoiceCardProps) {
