              ...
              {data.map((invoice) => (
                <div key={invoice.id} className="p-4 border rounded-lg">
                  ...
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <div className="text-right">
                      {invoice.voucher ? (
                        <span className="text-green-600 font-medium">✓ Voucher Created</span>
                      ) : (
                  ...
                  {invoice.voucher && (
                    <div className="mt-3 pt-3 border-t">
                      <p className="text-sm font-medium text-muted-foreground mb-2">Voucher Details:</p>
                      <div className="grid grid-cols-3 gap-4 text-sm">
                        <div>
                          <span className="text-muted-foreground">Category:</span>
                          <p className="font-medium">{invoice.voucher.expenseCategory}</p>
                        </div>
                        <div>
                          <span className="text-muted-foreground">Classification:</span>
                          <p className="font-medium">{invoice.voucher.accountClassification}</p>
                        </div>
                        <div>
                          <span className="text-muted-foreground">Tax Treatment:</span>
                          <p className="font-medium">{invoice.voucher.taxTreatment}</p>
                        </div>
                      </div>
                    </div>
                  )}
